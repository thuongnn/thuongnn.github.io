...
- Các không gian tên AWS tuân theo quy ước **AWS/<dịch vụ>**, *ví dụ: AWS/EC2, AWS/ELB*.
...
- Đơn vị biểu thị **đơn vị đo lường** của số liệu, *ví dụ: số lượng, byte, %, v.v.*
...
- CloudWatch tổng hợp thống kê theo độ dài chu kỳ được chỉ định trong các lệnh gọi *GetMetricStatistics*.
...
- Tuy nhiên, việc gửi giá trị **0** thay vì không gửi giá trị có thể hữu ích để:
    - Theo dõi tình trạng ứng dụng, *ví dụ: cấu hình cảnh báo để thông báo nếu không có số liệu nào được gửi mỗi 5 phút*.
