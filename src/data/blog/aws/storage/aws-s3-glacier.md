...
| S3 Glacier Flexible Retrieval *(trước đây là S3 Glacier)* | **Truy xuất trong vài phút đến vài giờ**, có 3 tùy chọn:  - **Expedited**: 1-5 phút.  - **Standard**: 3-5 giờ.  - **Bulk**: 5-12 giờ. |
...
- **Lưu trữ tài liệu số** (*digital media archives*).
- **Lưu trữ dữ liệu tuân thủ quy định** (*regulatory compliance*).
- **Dữ liệu tài chính, hồ sơ y tế**.
- **Lưu trữ dữ liệu gen** (*raw genomic sequence data*).
