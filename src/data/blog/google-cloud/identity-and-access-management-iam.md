...
- **Kịch bản sử dụng**: Một ứng dụng trong một VM Instance cần quyền truy cập vào Cloud Storage, chúng ta không muốn sử dụng *personal credentials* để allow access cho ứng dụng.
